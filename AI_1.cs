...
public class AI_1 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (usingPast)
        {
            string[] lines = File.ReadAllLines(Application.dataPath + "/network_1.txt");
    ...
    void FixedUpdate()
    {
        ...
        else if (frames > FRAMES + 3)
        {
            ...
            if (test % 200 == 0)
            {
                File.AppendAllText(Application.dataPath + "/errors.txt", "1 - test1: " + test + " error: " + count + "\n");
            }
...
/*
                ...
                File.AppendAllText(Application.dataPath + "/errors.txt", "1 - gamma: " + gamma + " error: " + count + "\n");
                gamma /= 1.5;*/
            }
            count = 0;
            inHand = true;
    ...
    void firstSets() {
        ...
        target_trsm[0] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT");
        target_trsm[1] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT/l_upleg_JNT");
        target_trsm[2] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT/l_upleg_JNT/l_leg_JNT");
        target_trsm[3] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT/l_upleg_JNT/l_leg_JNT/l_foot_JNT/l_toebase_JNT");
        target_trsm[4] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT/r_upleg_JNT");
        target_trsm[5] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT/r_upleg_JNT/r_leg_JNT");
        target_trsm[6] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT/r_upleg_JNT/r_leg_JNT/r_foot_JNT/r_toebase_JNT");
        target_trsm[7] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT/spine_JNT/spine1_JNT");
        target_trsm[8] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT/spine_JNT/spine1_JNT/spine2_JNT/l_shoulder_JNT/l_arm_JNT");
        target_trsm[9] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT/spine_JNT/spine1_JNT/spine2_JNT/l_shoulder_JNT/l_arm_JNT/l_forearm_JNT");
        target_trsm[10] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT/spine_JNT/spine1_JNT/spine2_JNT/l_shoulder_JNT/l_arm_JNT/l_forearm_JNT/l_hand_JNT");
        target_trsm[11] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT/spine_JNT/spine1_JNT/spine2_JNT/l_shoulder_JNT/l_arm_JNT/l_forearm_JNT/l_hand_JNT/l_handMiddle1_JNT/l_handMiddle2_JNT");
        target_trsm[12] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT/spine_JNT/spine1_JNT/spine2_JNT/neck_JNT");
        target_trsm[13] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT/spine_JNT/spine1_JNT/spine2_JNT/r_shoulder_JNT/r_arm_JNT");
        target_trsm[14] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT/spine_JNT/spine1_JNT/spine2_JNT/r_shoulder_JNT/r_arm_JNT/r_forearm_JNT");
        target_trsm[15] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT/spine_JNT/spine1_JNT/spine2_JNT/r_shoulder_JNT/r_arm_JNT/r_forearm_JNT/r_hand_JNT");
        target_trsm[16] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT/spine_JNT/spine1_JNT/spine2_JNT/r_shoulder_JNT/r_arm_JNT/r_forearm_JNT/r_hand_JNT/r_handMiddle1_JNT/r_handMiddle2_JNT");
        if (target_trsm[16] == null) Debug.Log("BRRUUUUH");


        targrbs[0] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT").GetComponent<Rigidbody>();
        targrbs[1] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT/l_upleg_JNT").GetComponent<Rigidbody>();
        targrbs[2] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT/l_upleg_JNT/l_leg_JNT").GetComponent<Rigidbody>();
        targrbs[3] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT/l_upleg_JNT/l_leg_JNT/l_foot_JNT/l_toebase_JNT").GetComponent<Rigidbody>();
        targrbs[4] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT/r_upleg_JNT").GetComponent<Rigidbody>();
        targrbs[5] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT/r_upleg_JNT/r_leg_JNT").GetComponent<Rigidbody>();
        targrbs[6] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT/r_upleg_JNT/r_leg_JNT/r_foot_JNT/r_toebase_JNT").GetComponent<Rigidbody>();
        targrbs[7] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT/spine_JNT/spine1_JNT").GetComponent<Rigidbody>();
        targrbs[8] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT/spine_JNT/spine1_JNT/spine2_JNT/l_shoulder_JNT/l_arm_JNT").GetComponent<Rigidbody>();
        targrbs[9] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT/spine_JNT/spine1_JNT/spine2_JNT/l_shoulder_JNT/l_arm_JNT/l_forearm_JNT").GetComponent<Rigidbody>();
        targrbs[10] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT/spine_JNT/spine1_JNT/spine2_JNT/l_shoulder_JNT/l_arm_JNT/l_forearm_JNT/l_hand_JNT").GetComponent<Rigidbody>();
        targrbs[11] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT/spine_JNT/spine1_JNT/spine2_JNT/l_shoulder_JNT/l_arm_JNT/l_forearm_JNT/l_hand_JNT/l_handMiddle1_JNT/l_handMiddle2_JNT").GetComponent<Rigidbody>();
        targrbs[12] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT/spine_JNT/spine1_JNT/spine2_JNT/neck_JNT").GetComponent<Rigidbody>();
        targrbs[13] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT/spine_JNT/spine1_JNT/spine2_JNT/r_shoulder_JNT/r_arm_JNT").GetComponent<Rigidbody>();
        targrbs[14] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT/spine_JNT/spine1_JNT/spine2_JNT/r_shoulder_JNT/r_arm_JNT/r_forearm_JNT").GetComponent<Rigidbody>();
        targrbs[15] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT/spine_JNT/spine1_JNT/spine2_JNT/r_shoulder_JNT/r_arm_JNT/r_forearm_JNT/r_hand_JNT").GetComponent<Rigidbody>();
        targrbs[16] = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT/spine_JNT/spine1_JNT/spine2_JNT/r_shoulder_JNT/r_arm_JNT/r_forearm_JNT/r_hand_JNT/r_handMiddle1_JNT/r_handMiddle2_JNT").GetComponent<Rigidbody>();
        ...
        targBall = perfect.transform.Find("throw1_customModel_mfG4iCwRbRee1GxaHvYqr3/hips_JNT/spine_JNT/spine1_JNT/spine2_JNT/r_shoulder_JNT/r_arm_JNT/r_forearm_JNT/r_hand_JNT/r_handMiddle1_JNT/r_handMiddle2_JNT/Ball");
    ...
    void writeStuff(bool best)
    {
        ...
        s += "\n";
        File.AppendAllText(Application.dataPath + "/network_1.txt", s);
